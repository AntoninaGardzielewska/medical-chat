...
class ChromaDB:
    def __init__(self, path: str, collection_name: str):
        ...
        self.model = SentenceTransformer("neuml/pubmedbert-base-embeddings", device=device)
    ...
    def add_file_data(self, path: str, verbose: bool = False) -> None:
        ...
        for i in range(0, total_records, batch_size):
            ...
            if verbose:
                print(f" Processing batch {i // batch_size + 1}: documents {i} to {min(i + batch_size, total_records)}...")
            ...
            for chunk in batch_chunks:
                ...
                if "authors" in meta and not isinstance(meta["authors"], (str, int, float, bool)):
